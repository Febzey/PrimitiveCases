    ...
    return (
        <AnimateSharedLayout>
            <motion.div
                ...
                layout
                className="w-4/5 bg-neutral-400 bg-opacity-50 dark:bg-cartItem bg-center bg-no-repeat bg-cover rounded-sm flex flex-col items-center justify-center p-6 dark:text-neutral-50 font-dmSans">
