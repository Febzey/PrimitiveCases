    ...
    return (
        <div className="fixed h-screen z-50 w-[60%] md:w-1/5 dark:bg-zinc-800 bg-neutral-300 shadow-xl flex flex-col overflow-scroll overflow-x-hidden py-10">
                ...
                {filteredArr.length !== 0 &&
                    <div className="flex flex-col gap-2">
                        <button
                            ...
                            className="rounded bg-red-400 py-2 text-neutral-50 font-Poppins duration-200 text-xs ease-in-out transform motion-safe hover:scale-110 hover:bg-red-500">
                            Clear Cart
                        </button>
                        <Link
                            to="/checkout"
                            className="text-center rounded bg-emerald-500 px-6 py-3 text-neutral-50 font-Poppins duration-200 ease-in-out transform motion-safe hover:scale-110 hover:bg-emerald-600">
                            Checkout
                        </Link>
            ...
            <div className="flex ml-auto mr-auto items-center justify-center w-full flex-col gap-6">
                {filteredArr.length !== 0
                        ? filteredArr.map(items => (<CartItems items={items} removeOne={removeOne} />))
