const Item_ = ({ props, addItemsToCarts }) => {
    ...
    return (
        <div className="md:w-4/5 bg-neutral-100 w-full p-11 py-12 flex flex-col items-center justify-center gap-4 rounded-sm shadow-md dark:bg-zinc-800 ml-auto mr-auto">
            <div className="flex flex-col md:flex-row w-full gap-3 ml-auto">
                ...
                <div className="flex flex-col gap-2 md:w-[50%] w-full">
                    ...
                    <div className="flex flex-row items-center font-dmSans gap-2">
                        <p className="bg-neutral-300 text-zinco-700 dark:bg-neutral-500 text-xs text-center dark:text-white px-1 ml-auto">{props.color}</p>
