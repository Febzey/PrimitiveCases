...
export default function HandleDelete() {
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch('http://localhost:3005/api/delete', {
                method: 'POST',
    ...
    return (
        <div className="w-full md:w-3/4 py-32 mx-auto flex items-center justify-center flex-col dark:text-neutral-100 shadow-lg dark:bg-zinc-800 gap-12">
            <h1 className="text-3xl underline underline-offset-2 decoration-lg decoration-sky-500">Delete an item</h1>
