    ...
    return (
        <div>
            <div className="fixed flex h-16 w-full dark:bg-zinc-900 bg-neutral-100 bg-opacity-75 shadow-sm backdrop-filter backdrop-blur items-center">
                ...
                <div className="absolute right-0 mr-3 md:mr-10 text-zinb-900 text-zinc-800 dark:text-sky-500 flex flex-row gap-2 items-center">
                    <LoginButton />
                    {user &&
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <div>
                                <FaBars className="text-3xl dark:text-sky-500 cursor-pointer duration-75 hover:text-sky-500 dark:hover:text-indigo-600" onClick={() => setDropdown(prev => !prev)} />
                                {dropdown &&
                                    <div className="bg-stone-100 absolute right-0 top-[3.5rem] rounded-sm shadow-lg dark:bg-zinc-700">
                                        <ul className="flex flex-col items-left gap-1 font-dmSans">
                                            <Rlink to="/"><li className="text-neutral-600 hover:bg-gray-300 w-full px-6 py-2 cursor-pointer dark:text-sky-500 dark:hover:bg-zinc-600">Home</li></Rlink>
                                            <li className="text-neutral-600 hover:bg-gray-300 w-full px-6 py-2 cursor-pointer dark:text-sky-500 dark:hover:bg-zinc-600" onClick={() => logout()}>Sign off</li>
                                            <li className="text-neutral-600 hover:bg-gray-300 w-full px-6 py-2 cursor-pointer dark:text-sky-500 dark:hover:bg-zinc-600" onClick={() => changeCartState()}>View cart</li>
                                        </ul>
                                    </div>
                                }
                            </div>
